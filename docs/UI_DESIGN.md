...
While the lane's *Follow* is off (D-UI-16, D-UI-38) the play head is the user's, not the transport's; the chain's own *Follow* only says whether the timeline scrolls. **Past
