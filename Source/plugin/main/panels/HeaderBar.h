...
// model switch, the bank with previous / next and its menu, the STOCK /
...
private:
    ...
    TextLine wordmark_, wordmarkSmall_, modelLabel_, bankLabel_;
    ui::Segmented model_;
    ...
    std::unique_ptr<juce::ButtonParameterAttachment> hexAtt_;
    float scale_ = 1.0f;
