...
constexpr LsdjModel kLsdj9   { "LSDj 9.2.J - 9.4.2 (format 22)",   22, 22, 31, kLetters9,      EnvelopeLaw::SoftwareStages, kEnvPeriods9, NoiseRule::Map,   kNoise9,   36, 155, NoiseS::Semitones, PitchLaw::Semitone, VibratoLaw::Semitone,         3, -12, true, 2, 0, true,  true,  true, true, false, true, true, false, true };
constexpr LsdjModel kLsdj886 { "LSDj 8.8.6 (format 15)",           15, 15, 21, kLetters9,      EnvelopeLaw::SoftwareStages, kEnvPeriods9, NoiseRule::Raw,   kNoise886, 36, 115, NoiseS::Nibbles,   PitchLaw::Semitone, VibratoLaw::Semitone,         2, -12, true, -1, 1, true,  true,  false, true, false, true, false, true, true };
constexpr LsdjModel kLsdj84  { "LSDj 8.4.0 - 8.5.1 (format 11)",   11, 11, 14, kLetters9,      EnvelopeLaw::HardwareStages, nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Semitone, VibratoLaw::Semitone,         2, -12, true, -1, 1, false, true,  false, true, false, true, false, true, true };
constexpr LsdjModel kLsdj68  { "LSDj 6.8.2 - 7.0.2 (format 7)",     7,  7, 10, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Semitone, VibratoLaw::Semitone,         2, -12, true, -1, 1, false, true,  false, false, false, true, false, true, true };
constexpr LsdjModel kLsdj57  { "LSDj 5.7.8 - 6.4.5 (formats 4-5)",  4,  4,  6, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Semitone, VibratoLaw::Semitone,         2, -12, true, -1, 1, false, true,  false, false, false, false, false, true, true };
constexpr LsdjModel kLsdj48  { "LSDj 4.8.0 - 5.0.3 (format 3)",     3,  3,  3, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Register, VibratoLaw::Semitone,         2, -12, true, -1, 1, false, false, false, false, false, false, false, true, true };
constexpr LsdjModel kLsdj44  { "LSDj 4.4.0 - 4.7.3 (format 3)",     3,  3,  3, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Register, VibratoLaw::Semitone,         2, -12, true, -1, 1, true,  false, false, false, false, false, false, true, true };
constexpr LsdjModel kLsdj404  { "LSDj 4.0.4 - 4.3.0 (format 2)",     2,  2,  2, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Register, VibratoLaw::Semitone,         2, -12, true, -1, 1, true,  false, false, false, false, false, false, true, true };
constexpr LsdjModel kLsdj36  { "LSDj 3.6.8 - 3.9.2 (format 2)",     2,  2,  2, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Register, VibratoLaw::Semitone,         2, -12, true, -1, 1, true,  false, false, false, true, false, false, true, true };
constexpr LsdjModel kLsdj31  { "LSDj 3.1.5 - 3.5.1 (format 0)",     0,  0,  1, kLettersLegacy, EnvelopeLaw::Chip,           nullptr, NoiseRule::Shape, nullptr,   36, 115, NoiseS::Nibbles,   PitchLaw::Register, VibratoLaw::RegisterOneSided, 2, -12, true, -1, 1, true,  false, false, false, true, false, false, true, true };

constexpr const LsdjModel* kModels[] = { &kLsdj9, &kLsdj886, &kLsdj84, &kLsdj68, &kLsdj57, &kLsdj48, &kLsdj44, &kLsdj404, &kLsdj36, &kLsdj31 };   // newest first
...
constexpr VersionModel kVersionModels[] = {
    { 9, 2, 0, &kLsdj9 }, { 8, 8, 6, &kLsdj886 }, { 8, 4, 0, &kLsdj84 }, { 6, 8, 2, &kLsdj68 }, { 5, 7, 8, &kLsdj57 },
