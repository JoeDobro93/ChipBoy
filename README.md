...
tracker with song tabs — each song owning its own bank, an LSDj `.sav` or `.lsdprj` importable into them (*Import .sav…*, every LSDj release from 3.1 up) — that follows the host
